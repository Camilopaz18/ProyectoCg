...
public class Skeleto_Volver : StateMachineBehaviour
{
    ...
    {
        seguimiento= animator.GetComponent<Seguimiento>();
        puntoInicial= seguimiento.puntoInicial;
    }
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        seguimiento.Girar(puntoInicial);
